...
public class CParser extends Parser {
	...
	public static final int
		...
		LineComment=113, CCG_SPECIAL_ID=114, CCG_SPECIAL_SEQ=115, CCG_SPECIAL_EXPR=116, 
		CCG_SPECIAL_BLOCK=117, Directive=118;
	public static final int
	...
	private static final String[] _SYMBOLIC_NAMES = {
		...
		"CCG_SPECIAL_SEQ", "CCG_SPECIAL_EXPR", "CCG_SPECIAL_BLOCK", "Directive"
	};
	...
	public final GccAttributeContext gccAttribute() throws RecognitionException {
		...
		try {
			...
			case CCG_SPECIAL_EXPR:
			case CCG_SPECIAL_BLOCK:
			case Directive:
				enterOuterAlt(_localctx, 1);
				{
				setState(823);
